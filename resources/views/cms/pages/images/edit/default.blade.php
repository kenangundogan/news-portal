            ...
            <x-cms.base.form id="form" name="form" action="{{ route('images.update', $image->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    ...
                    <div class="flex items-end">
                        ...
                        @if($image->image1x1)
                            <div class="w-16 h-16 aspect-1x1 flex-none relative overflow-hidden bg-gray-50">
                    ...
                    <div class="flex items-end">
                        ...
                        @if($image->image1x2)
                            <div class="w-8 h-16 aspect-1x1 flex-none relative overflow-hidden bg-gray-50">
                    ...
                    <div class="flex items-end">
                        ...
                        @if($image->image16x9)
                            <div class="w-28 h-16 aspect-1x1 flex-none relative overflow-hidden bg-gray-50">
